...
Use 'keploy mock record' to capture outgoing network calls while running a command.
Use 'keploy mock replay' (or 'keploy mock test') to run a command with recorded mocks.
