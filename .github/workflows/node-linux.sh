...
report_file3="./keploy/testReports/test-run-1/report-3.yaml"
test_status3=$(grep 'status:' "$report_file3" | head -n 1 | awk '{print $2}')
report_file4="./keploy/testReports/test-run-1/report-4.yaml"
test_status4=$(grep 'status:' "$report_file4" | head -n 1 | awk '{print $2}')
report_file5="./keploy/testReports/test-run-1/report-5.yaml"
test_status5=$(grep 'status:' "$report_file5" | head -n 1 | awk '{print $2}')
report_file6="./keploy/testReports/test-run-1/report-6.yaml"
