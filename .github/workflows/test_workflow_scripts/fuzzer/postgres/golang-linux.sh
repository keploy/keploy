...
# upload keploy as zip to bashupload

zip -r keploy.zip keploy/
KEPLOY_ZIP_URL=$(curl -sF "file=@keploy.zip" https://bashupload.com)
echo "Keploy zip uploaded to: $KEPLOY_ZIP_URL"
