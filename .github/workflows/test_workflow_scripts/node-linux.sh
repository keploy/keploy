...
sudo -E env PATH=$PATH ./../../keployv2 rerecord -c 'npm start' --inCi=true &> "${test_container}.txt"
...
sudo -E env PATH=$PATH ./../../keployv2 test -c 'npm start' --apiTimeout 60 --delay 20 --generate-github-actions=false &> "${test_container}.txt"
