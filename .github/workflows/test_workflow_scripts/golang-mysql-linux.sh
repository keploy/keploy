...
sudo docker run -p 3306:3306 --rm --name mysql -e MYSQL_ROOT_PASSWORD=my-secret-pw -d mysql:latest

# Wait until MySQL is ready to accept connections
until sudo docker exec mysql mysqladmin ping -h "127.0.0.1" --silent; do
