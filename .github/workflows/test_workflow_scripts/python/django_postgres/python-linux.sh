...
for i in {1..2}; do
    ...
    send_request &
    $RECORD_BIN record -c "python3 manage.py runserver --noreload"   2>&1 | tee "${app_name}.txt"
...
# Testing phase
$REPLAY_BIN test -c "python3 manage.py runserver --noreload" --delay 10    2>&1 | tee test_logs.txt
