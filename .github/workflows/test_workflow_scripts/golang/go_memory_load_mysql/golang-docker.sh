...
MIXED_API_VU_STAGE_TARGETS="${MIXED_API_VU_STAGE_TARGETS:-2,4,6,2}"
LARGE_PAYLOAD_PREALLOCATED_VUS="${LARGE_PAYLOAD_PREALLOCATED_VUS:-4}"
LARGE_PAYLOAD_MAX_VUS="${LARGE_PAYLOAD_MAX_VUS:-10}"
