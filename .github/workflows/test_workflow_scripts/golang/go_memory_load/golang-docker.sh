...
LARGE_PAYLOAD_MAX_VUS="${LARGE_PAYLOAD_MAX_VUS:-18}"
LARGE_PAYLOAD_STAGE_TARGETS="${LARGE_PAYLOAD_STAGE_TARGETS:-1,2,1}"
LARGE_PAYLOAD_SIZES_MB="${LARGE_PAYLOAD_SIZES_MB:-1,2}"
...
#   - ubuntu-latest has 2 shared vCPUs (CPU contention slows everything)
#   - Keploy proxy adds latency (especially during memory pressure transitions)
#   - Connection: close during pressure mode adds reconnection overhead
THRESHOLD_HTTP_FAILED_RATE="${THRESHOLD_HTTP_FAILED_RATE:-0.05}"
THRESHOLD_HTTP_P95="${THRESHOLD_HTTP_P95:-5000}"
THRESHOLD_HTTP_AVG="${THRESHOLD_HTTP_AVG:-2500}"
THRESHOLD_LARGE_INSERT_P95="${THRESHOLD_LARGE_INSERT_P95:-8000}"
THRESHOLD_LARGE_GET_P95="${THRESHOLD_LARGE_GET_P95:-8000}"
THRESHOLD_LARGE_DELETE_P95="${THRESHOLD_LARGE_DELETE_P95:-5000}"
