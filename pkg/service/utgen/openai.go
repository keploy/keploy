...
func (ai *OpenAIClient) Call(
	...
	if ai.APIBase == ai.APIServerURL {
		...
		ai.Logger.Debug(
			...
			zap.String("api_server_url", ai.APIServerURL),
		...
		req, err := http.NewRequest(
			"POST",
			fmt.Sprintf("%s/ai/call", ai.APIServerURL),
			bytes.NewBuffer(aiRequestBytes),
		)
		if err != nil {
	...
	req, err := http.NewRequestWithContext(
		ctx,
		"POST",
		apiBaseURL+"/chat/completions"+queryParams,
...
func (ai *OpenAIClient) SendCoverageUpdate(
	ctx context.Context,
	sessionID string,
