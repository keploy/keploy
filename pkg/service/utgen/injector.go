...
func NewInjectorBuilder(logger *zap.Logger) *Injector {
...
func (i *Injector) libraryInstalled(language string) ([]string, error) {
...
func (i *Injector) uninstallLibraries(language string, installedPackages []string) error {
...
func (i *Injector) updateImports(filePath string, language string, imports string) (int, error) {
