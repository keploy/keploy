...
func (r *Run) Get(ctx context.Context, summary bool, cid string, user, app, id *string, from, to *time.Time) ([]*TestRun, error) {
	res, err := r.rdb.Read(ctx, cid, user, app, id, from, to)
	if err != nil {
