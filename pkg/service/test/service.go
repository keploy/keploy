...
type Tester interface {
	Test(path string, proxyPort uint32, testReportPath string, appCmd string, tests map[string][]string, appContainer, networkName string, Delay uint64, passThorughPorts []uint, apiTimeout uint64, globalNoise models.GlobalNoise, noise models.TestsetNoise) bool
