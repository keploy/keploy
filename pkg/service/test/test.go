...
func (t *tester) InitialiseTest(cfg *TestConfig) (InitialiseTestReturn, error) {
	...
	tele := telemetry.NewTelemetry(!cfg.DisableTele, false, teleFS, t.logger, "", nil)
...
func (t *tester) Test(path string, testReportPath string, appCmd string, options TestOptions, disableTele bool) bool {
