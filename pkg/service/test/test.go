...
func (t *tester) InitialiseRunTestSet(cfg *RunTestSetConfig) InitialiseRunTestSetReturn {
	...
	if cfg.GenerateTestReport {
		...
		t.logger.Info("Test Report Generation is disabled for this test run")
	}
