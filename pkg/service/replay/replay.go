...
func NewReplayer(logger *zap.Logger, testDB TestDB, mockDB MockDB, reportDB ReportDB, testSetDB TestSetDB, telemetry Telemetry, instrumentation Instrumentation, config *config.Config) Service {
