	...
	for _, tt := range []struct {
		...
		},
		{
			...
			expected: &proto.Mock{
				...
				Spec: &proto.Mock_SpecSchema{
					Req: &proto.HttpReq{
						Header:     map[string]*proto.StrArr{"User-Agent": &proto.StrArr{Value: []string{"NewAgent2"}}},
						URL:        "keploy.io",
						Method:     "POST",
						ProtoMajor: 1,
						ProtoMinor: 2,
