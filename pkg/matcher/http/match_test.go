...
func TestMatch_HeaderNoiseUpdate_123(t *testing.T) {
	...
	// Act
	pass, result := Match(tc, actualResponse, noiseConfig, ignoreOrdering, false, nil, logger, true)
...
func TestMatch_InvalidJSONBody_321(t *testing.T) {
	...
	pass, res := Match(tc, actualResponse, noiseConfig, false, true, nil, logger, true)
...
func TestMatch_JsonMarshalErrorInDiff_987(t *testing.T) {
	...
	pass, res := Match(tc, actualResponse, noiseConfig, false, false, nil, logger, true)
...
func TestMatch_CompareAll_Disabled(t *testing.T) {
	...
	pass, result := Match(tc, actualResponse, noiseConfig, false, false, nil, logger, true)
...
func TestMatch_CompareAll_Enabled(t *testing.T) {
	...
	pass, result := Match(tc, actualResponse, noiseConfig, false, true, nil, logger, true)
