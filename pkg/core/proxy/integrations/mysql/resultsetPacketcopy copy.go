...
// 	printByteArray("ResultSetDataPacket", b)
...
// 	printByteArray("Original buffer(resultset)", original)
// 	printByteArray("Columns & EOF done", b)
...
func encodeMySQLResultSet(resultSet *models.MySQLResultSet) ([]byte, error) {
	...
	if resultSet.EOFPresentAfterColumn {
		sequenceID++
	...
	buf.Write(resultSet.EOFAfterRows)
...
func encodeRow(_ *models.Row, columnValues []models.RowCol) ([]byte, error) {
