...
func (h *Hook) LaunchPerfBufferConsumers(connectionFactory *conn.Factory) {
...
func (h *Hook) launchSocketOpenEvent(connectionFactory *conn.Factory) {
...
func (h *Hook) launchSocketDataEvent(connectionFactory *conn.Factory) {
...
func (h *Hook) launchSocketCloseEvent(connectionFactory *conn.Factory) {
...
func socketDataEventCallback(reader *ringbuf.Reader, connectionFactory *conn.Factory, logger *zap.Logger) {
...
func socketOpenEventCallback(reader *perf.Reader, connectionFactory *conn.Factory, logger *zap.Logger) {
	for {
...
func socketCloseEventCallback(reader *perf.Reader, connectionFactory *conn.Factory, logger *zap.Logger) {
	for {
