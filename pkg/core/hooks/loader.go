...
func (h *Hook) LoadHooks(appCmd, appContainer string, pid uint32, ctx context.Context, filters *models.TestFilter) error {
	...
	connectionFactory := conn.NewFactory(time.Minute, h.logger)
	go func() {
