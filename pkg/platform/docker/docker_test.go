...
func (m *MockDockerClient) BuildCachePrune(ctx context.Context, opts build.CachePruneOptions) (*build.CachePruneReport, error) {
	return nil, nil
}
...
func (m *MockDockerClient) ImageLoad(ctx context.Context, input io.Reader, options image.LoadOptions) (image.LoadResponse, error) {
...
func (m *MockDockerClient) BuildCachePruneReport(ctx context.Context, cfg build.CachePruneOptions) (build.CachePruneReport, error) {
