...
// isMockeryFile checks if a Go file was generated by mockery by verifying its header
// Returns true for .go files with mockery generation header
func isMockeryFile(filename string, logger *zap.Logger) bool {
	// Only check Go files
	...
	if err != nil {
		logger.Warn("Failed to verify mockery file",
