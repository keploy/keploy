...
type ComplexityRoot struct {
	Mutation struct {
		...
		UpdateReportWithCov func(childComplexity int, testRunID string, testSetID string, language string) int
	}
...
type MutationResolver interface {
	...
	UpdateReportWithCov(ctx context.Context, testRunID string, testSetID string, language string) (bool, error)
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Mutation.updateReportWithCov":
		if e.complexity.Mutation.UpdateReportWithCov == nil {
			break
		}

		args, err := ec.field_Mutation_updateReportWithCov_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Mutation.UpdateReportWithCov(childComplexity, args["testRunId"].(string), args["testSetId"].(string), args["language"].(string)), true
...
func (ec *executionContext) field_Mutation_updateReportWithCov_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	var arg0 string
	if tmp, ok := rawArgs["testRunId"]; ok {
...
func (ec *executionContext) _Mutation_updateReportWithCov(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Mutation_updateReportWithCov(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().UpdateReportWithCov(rctx, fc.Args["testRunId"].(string), fc.Args["testSetId"].(string), fc.Args["language"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) fieldContext_Mutation_updateReportWithCov(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Mutation",
		Field:      field,
		IsMethod:   true,
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	if fc.Args, err = ec.field_Mutation_updateReportWithCov_args(ctx, field.ArgumentMap(ec.Variables)); err != nil {
		ec.Error(ctx, err)
		return fc, err
	}
	return fc, nil
...
func (ec *executionContext) _Mutation_startHooks(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNTestRunInfo2ᚖexampleᚗcomᚋgraphᚋmodelᚐTestRunInfo(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_testSetStatus(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNTestSetStatus2ᚖexampleᚗcomᚋgraphᚋmodelᚐTestSetStatus(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Mutation(ctx context.Context, sel ast.SelectionSet) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "updateReportWithCov":
			out.Values[i] = ec.OperationContext.RootResolverMiddleware(innerCtx, func(ctx context.Context) (res graphql.Marshaler) {
				return ec._Mutation_updateReportWithCov(ctx, field)
			})
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
...
func (ec *executionContext) marshalNTestRunInfo2exampleᚗcomᚋgraphᚋmodelᚐTestRunInfo(ctx context.Context, sel ast.SelectionSet, v model.TestRunInfo) graphql.Marshaler {
	return ec._TestRunInfo(ctx, sel, &v)
}

func (ec *executionContext) marshalNTestRunInfo2ᚖexampleᚗcomᚋgraphᚋmodelᚐTestRunInfo(ctx context.Context, sel ast.SelectionSet, v *model.TestRunInfo) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalNTestSetStatus2exampleᚗcomᚋgraphᚋmodelᚐTestSetStatus(ctx context.Context, sel ast.SelectionSet, v model.TestSetStatus) graphql.Marshaler {
	return ec._TestSetStatus(ctx, sel, &v)
}

func (ec *executionContext) marshalNTestSetStatus2ᚖexampleᚗcomᚋgraphᚋmodelᚐTestSetStatus(ctx context.Context, sel ast.SelectionSet, v *model.TestSetStatus) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
