...
func (r *mutationResolver) RunTestSet(ctx context.Context, testSet string) (*model.RunTestSetResponse, error) {
	...
	disableReportFile := r.Resolver.DisableReportFile
	...
	go func() {
		...
		tester.RunTestSet(testSet, testCasePath, testReportPath, disableReportFile, "", "", "", delay, 30*time.Second, pid, ys, loadedHooks, testReportFS, testRunChan, r.ApiTimeout, ctx, nil, nil, serveTest, false)
	}()
