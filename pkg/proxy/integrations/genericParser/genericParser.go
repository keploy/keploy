...
func encodeGenericOutgoing(requestBuffer []byte, clientConn, destConn net.Conn, h *hooks.Hook, logger *zap.Logger, ctx context.Context) error {
	...
	for {
		...
		// if err != nil {
		// 	log.Error("failed to set the read deadline for the client connection", zap.Error(err))
		// 	return err
		// }
		// // }
		...
		// if err != nil {
		// 	log.Error("failed to set the read deadline for the destination connection", zap.Error(err))
		// 	return err
		// }
		// for {
