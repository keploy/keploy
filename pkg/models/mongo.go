...
func init() {
	...
	gob.RegisterName("*models.MongoOpMessage", &MongoOpMessage{})
	gob.RegisterName("*models.MongoOpQuery", &MongoOpQuery{})
	gob.RegisterName("*models.MongoOpReply", &MongoOpReply{})
	gob.RegisterName("*models.MongoOpUnknown", &MongoOpUnknown{})
	...
	gob.RegisterName("*models.MongoOpCompressed", &MongoOpCompressed{})
	gob.RegisterName("*models.MongoOpUpdate", &MongoOpUpdate{})
	gob.RegisterName("*models.MongoOpInsert", &MongoOpInsert{})
	gob.RegisterName("*models.MongoOpDelete", &MongoOpDelete{})
	gob.RegisterName("*models.MongoOpGetMore", &MongoOpGetMore{})
	gob.RegisterName("*models.MongoOpKillCursors", &MongoOpKillCursors{})
}
