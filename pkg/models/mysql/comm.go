...
type StmtPrepareOkPacket struct {
	...
	Filler               byte   `yaml:"filler" json:"filler"`
	WarningAvailable     bool   `yaml:"warning_available" json:"warning_available"`
	WarningCount         uint16 `yaml:"warning_count" json:"warning_count"`
	MetaFollowsAvailable bool   `yaml:"meta_follows_available" json:"meta_follows_available"`
	MetaFollows          byte   `yaml:"meta_follows" json:"meta_follows"`
