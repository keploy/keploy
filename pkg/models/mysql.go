...
type MySQLRequest struct {
	...
	ReadDelay int64              `json:"read_delay,omitempty" bson:"read_delay,omitempty"`
}
...
type MySQLOKPacket struct {
	AffectedRows uint64 `json:"affected_rows,omitempty" yaml:"affected_rows" bson:"affected_rows"`
	LastInsertID uint64 `json:"last_insert_id,omitempty" yaml:"last_insert_id" bson:"last_insert_id"`
	StatusFlags  uint16 `json:"status_flags,omitempty" yaml:"status_flags" bson:"status_flags"`
	Warnings     uint16 `json:"warnings,omitempty" yaml:"warnings" bson:"warnings"`
	Info         string `json:"info,omitempty" yaml:"info" bson:"info"`
}
