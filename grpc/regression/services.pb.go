...
type HttpReq struct {
	...
	// Deprecated: Marked as deprecated in grpc/regression/services.proto.
...
type GetTCRequest struct {
	...
	// If ENABLE_TEST_EXPORT is set to true, this represents the UID
	// of the testcase in MongoDB.
	// If ENABLE_TEST_EXPORT is set to false, this starts behaving as the
	// suffix of the testcase filename. To allow for flexibility in naming
	// convention, we do not restrict this to an integer. However, the
	// current implementation does expect it to be an integer.
	Id  string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	App string `protobuf:"bytes,2,opt,name=app,proto3" json:"app,omitempty"`
	// The absolute path of the folder which contains the testcases.
	// This is not needed if ENABLE_TEST_EXPORT is set to false.
	TestCasePath string `protobuf:"bytes,3,opt,name=TestCasePath,proto3" json:"TestCasePath,omitempty"`
	// The absolute path of the folder which contains the mocks.
	// This is not needed if ENABLE_TEST_EXPORT is set to false.
	MockPath string `protobuf:"bytes,4,opt,name=MockPath,proto3" json:"MockPath,omitempty"`
}
...
func (x *GetTCRequest) GetTestCasePath() string {
	if x != nil {
		return x.TestCasePath
	}
	return ""
...
func (x *GetTCRequest) GetMockPath() string {
	if x != nil {
		return x.MockPath
	}
	return ""
...
var file_grpc_regression_services_proto_rawDesc = []byte{
	...
	0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x54, 0x65, 0x73, 0x74, 0x43, 0x61, 0x73, 0x65, 0x50,
	0x61, 0x74, 0x68, 0x12, 0x1a, 0x0a, 0x08, 0x4d, 0x6f, 0x63, 0x6b, 0x50, 0x61, 0x74, 0x68, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x4d, 0x6f, 0x63, 0x6b, 0x50, 0x61, 0x74, 0x68, 0x22,
	...
	0x01, 0x28, 0x09, 0x52, 0x03, 0x45, 0x72, 0x72, 0x22, 0xd9, 0x08, 0x0a, 0x04, 0x4d, 0x6f, 0x63,
	...
	0x0c, 0x52, 0x04, 0x44, 0x61, 0x74, 0x61, 0x1a, 0x9a, 0x05, 0x0a, 0x0a, 0x53, 0x70, 0x65, 0x63,
	...
	,
	...
	0x3a, 0x02, 0x38, 0x01, 0x22, 0x41, 0x0a, 0x05, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x12, 0x24, 0x0a,
	0x04, 0x43, 0x6f, 0x6c, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x73, 0x65,
	0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x53, 0x71, 0x6c, 0x43, 0x6f, 0x6c, 0x52, 0x04, 0x43,
	0x6f, 0x6c, 0x73, 0x12, 0x12, 0x0a, 0x04, 0x52, 0x6f, 0x77, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28,
	0x09, 0x52, 0x04, 0x52, 0x6f, 0x77, 0x73, 0x22, 0x64, 0x0a, 0x06, 0x53, 0x71, 0x6c, 0x43, 0x6f,
	...
	,
	...
	0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x29, 0x0a, 0x0b, 0x50, 0x75, 0x74, 0x4d, 0x6f, 0x63, 0x6b,
	...
	0x4d, 0x6f, 0x63, 0x6b, 0x52, 0x05, 0x4d, 0x6f, 0x63, 0x6b, 0x73, 0x22, 0x68, 0x0a, 0x0c, 0x53,
	...
	0x6f, 0x64, 0x65, 0x12, 0x1c, 0x0a, 0x09, 0x4f, 0x76, 0x65, 0x72, 0x57, 0x72, 0x69, 0x74, 0x65,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x08, 0x52, 0x09, 0x4f, 0x76, 0x65, 0x72, 0x57, 0x72, 0x69, 0x74,
	0x65, 0x12, 0x12, 0x0a, 0x04, 0x4e, 0x61, 0x6d, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x04, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x27, 0x0a, 0x0d, 0x53, 0x74, 0x61, 0x72, 0x74, 0x4d, 0x6f,
	0x63, 0x6b, 0x52, 0x65, 0x73, 0x70, 0x12, 0x16, 0x0a, 0x06, 0x45, 0x78, 0x69, 0x73, 0x74, 0x73,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x45, 0x78, 0x69, 0x73, 0x74, 0x73, 0x32, 0xcc,
	...
	0x53, 0x74, 0x61, 0x72, 0x74, 0x4d, 0x6f, 0x63, 0x6b, 0x52, 0x65, 0x73, 0x70, 0x42, 0x3b, 0x0a,
	0x14, 0x69, 0x6f, 0x2e, 0x6b, 0x65, 0x70, 0x6c, 0x6f, 0x79, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e,
	0x73, 0x74, 0x75, 0x62, 0x73, 0x5a, 0x23, 0x67, 0x6f, 0x2e, 0x6b, 0x65, 0x70, 0x6c, 0x6f, 0x79,
	0x2e, 0x69, 0x6f, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2f, 0x67, 0x72, 0x70, 0x63, 0x2f,
	0x72, 0x65, 0x67, 0x72, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
