...
var file_grpc_regression_services_proto_rawDesc = []byte{
	...
	0x72, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x45, 0x72, 0x72, 0x22, 0xe8, 0x08,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x44, 0x61, 0x74, 0x61, 0x1a, 0xa9, 0x05, 0x0a,
	...
	0x41, 0x72, 0x72, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x42, 0x08,
	0x0a, 0x06, 0x5f, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x22, 0x41, 0x0a, 0x05, 0x54, 0x61, 0x62, 0x6c,
...
var file_grpc_regression_services_proto_msgTypes = make([]protoimpl.MessageInfo, 47)
var file_grpc_regression_services_proto_goTypes = []interface{}{
	...
	(*Table)(nil),           // 23: services.Table
	(*SqlCol)(nil),          // 24: services.SqlCol
	(*PutMockReq)(nil),      // 25: services.PutMockReq
	(*PutMockResp)(nil),     // 26: services.PutMockResp
	(*GetMockReq)(nil),      // 27: services.GetMockReq
	(*GetMockResp)(nil),     // 28: services.getMockResp
	(*StartMockReq)(nil),    // 29: services.StartMockReq
	(*StartMockResp)(nil),   // 30: services.StartMockResp
	nil,                     // 31: services.Dependency.MetaEntry
	nil,                     // 32: services.TestCaseReq.ReplaceEntry
	nil,                     // 33: services.TestCase.AllKeysEntry
	nil,                     // 34: services.TestCase.AnchorsEntry
	nil,                     // 35: services.HttpReq.URLParamsEntry
	nil,                     // 36: services.HttpReq.HeaderEntry
	nil,                     // 37: services.HttpResp.HeaderEntry
	nil,                     // 38: services.postTCResponse.TcsIdEntry
	nil,                     // 39: services.testResponse.PassEntry
	(*Mock_Request)(nil),    // 40: services.Mock.Request
	(*Mock_Object)(nil),     // 41: services.Mock.Object
	(*Mock_SpecSchema)(nil), // 42: services.Mock.SpecSchema
	nil,                     // 43: services.Mock.Request.HeaderEntry
	nil,                     // 44: services.Mock.SpecSchema.MetadataEntry
	nil,                     // 45: services.Mock.SpecSchema.AssertionsEntry
	nil,                     // 46: services.PutMockReq.ReplaceEntry
}
var file_grpc_regression_services_proto_depIdxs = []int32{
	31, // 0: services.Dependency.Meta:type_name -> services.Dependency.MetaEntry
	...
	32, // 6: services.TestCaseReq.Replace:type_name -> services.TestCaseReq.ReplaceEntry
	...
	33, // 14: services.TestCase.allKeys:type_name -> services.TestCase.AllKeysEntry
	34, // 15: services.TestCase.anchors:type_name -> services.TestCase.AnchorsEntry
	...
	35, // 19: services.HttpReq.URLParams:type_name -> services.HttpReq.URLParamsEntry
	36, // 20: services.HttpReq.Header:type_name -> services.HttpReq.HeaderEntry
	7,  // 21: services.HttpReq.Form:type_name -> services.FormData
	37, // 22: services.HttpResp.Header:type_name -> services.HttpResp.HeaderEntry
	4,  // 23: services.getTCSResponse.tcs:type_name -> services.TestCase
	38, // 24: services.postTCResponse.tcsId:type_name -> services.postTCResponse.TcsIdEntry
	39, // 25: services.testResponse.pass:type_name -> services.testResponse.PassEntry
	42, // 26: services.Mock.Spec:type_name -> services.Mock.SpecSchema
	24, // 27: services.Table.Cols:type_name -> services.SqlCol
	22, // 28: services.PutMockReq.Mock:type_name -> services.Mock
	46, // 29: services.PutMockReq.Replace:type_name -> services.PutMockReq.ReplaceEntry
	...
	43, // 35: services.Mock.Request.Header:type_name -> services.Mock.Request.HeaderEntry
	44, // 36: services.Mock.SpecSchema.Metadata:type_name -> services.Mock.SpecSchema.MetadataEntry
	41, // 37: services.Mock.SpecSchema.Objects:type_name -> services.Mock.Object
	...
	45, // 40: services.Mock.SpecSchema.Assertions:type_name -> services.Mock.SpecSchema.AssertionsEntry
	23, // 41: services.Mock.SpecSchema.Table:type_name -> services.Table
	...
	8,  // 44: services.Mock.Request.HeaderEntry.value:type_name -> services.StrArr
	8,  // 45: services.Mock.SpecSchema.AssertionsEntry.value:type_name -> services.StrArr
	10, // 46: services.RegressionService.End:input_type -> services.endRequest
	12, // 47: services.RegressionService.Start:input_type -> services.startRequest
	14, // 48: services.RegressionService.GetTC:input_type -> services.getTCRequest
	15, // 49: services.RegressionService.GetTCS:input_type -> services.getTCSRequest
	2,  // 50: services.RegressionService.PostTC:input_type -> services.TestCaseReq
	3,  // 51: services.RegressionService.DeNoise:input_type -> services.TestReq
	3,  // 52: services.RegressionService.Test:input_type -> services.TestReq
	25, // 53: services.RegressionService.PutMock:input_type -> services.PutMockReq
	27, // 54: services.RegressionService.GetMocks:input_type -> services.GetMockReq
	29, // 55: services.RegressionService.StartMocking:input_type -> services.StartMockReq
	11, // 56: services.RegressionService.End:output_type -> services.endResponse
	13, // 57: services.RegressionService.Start:output_type -> services.startResponse
	4,  // 58: services.RegressionService.GetTC:output_type -> services.TestCase
	16, // 59: services.RegressionService.GetTCS:output_type -> services.getTCSResponse
	17, // 60: services.RegressionService.PostTC:output_type -> services.postTCResponse
	18, // 61: services.RegressionService.DeNoise:output_type -> services.deNoiseResponse
	19, // 62: services.RegressionService.Test:output_type -> services.testResponse
	26, // 63: services.RegressionService.PutMock:output_type -> services.PutMockResp
	28, // 64: services.RegressionService.GetMocks:output_type -> services.getMockResp
	30, // 65: services.RegressionService.StartMocking:output_type -> services.StartMockResp
...
func file_grpc_regression_services_proto_init() {
	...
	file_grpc_regression_services_proto_msgTypes[42].OneofWrappers = []interface{}{}
	type x struct{}
