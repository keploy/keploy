...
var file_grpc_regression_services_proto_rawDesc = []byte{
	...
	0x02, 0x38, 0x01, 0x22, 0x95, 0x07, 0x0a, 0x04, 0x4d, 0x6f, 0x63, 0x6b, 0x12, 0x18, 0x0a, 0x07,
	...
	0x74, 0x61, 0x1a, 0xd6, 0x03, 0x0a, 0x0a, 0x53, 0x70, 0x65, 0x63, 0x53, 0x63, 0x68, 0x65, 0x6d,
	...
	0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x1a, 0x3b, 0x0a,
...
var file_grpc_regression_services_proto_depIdxs = []int32{
	...
	36, // 19: services.Mock.Spec:type_name -> services.Mock.SpecSchema
	...
	37, // 26: services.Mock.Request.Header:type_name -> services.Mock.Request.HeaderEntry
	38, // 27: services.Mock.SpecSchema.Metadata:type_name -> services.Mock.SpecSchema.MetadataEntry
	...
	39, // 31: services.Mock.SpecSchema.Assertions:type_name -> services.Mock.SpecSchema.AssertionsEntry
	7,  // 32: services.Mock.Request.HeaderEntry.value:type_name -> services.StrArr
	7,  // 33: services.Mock.SpecSchema.AssertionsEntry.value:type_name -> services.StrArr
	9,  // 34: services.RegressionService.End:input_type -> services.endRequest
	11, // 35: services.RegressionService.Start:input_type -> services.startRequest
	13, // 36: services.RegressionService.GetTC:input_type -> services.getTCRequest
	14, // 37: services.RegressionService.GetTCS:input_type -> services.getTCSRequest
	2,  // 38: services.RegressionService.PostTC:input_type -> services.TestCaseReq
	3,  // 39: services.RegressionService.DeNoise:input_type -> services.TestReq
	3,  // 40: services.RegressionService.Test:input_type -> services.TestReq
	20, // 41: services.RegressionService.PutMock:input_type -> services.PutMockReq
	22, // 42: services.RegressionService.GetMocks:input_type -> services.GetMockReq
	24, // 43: services.RegressionService.StartMocking:input_type -> services.StartMockReq
	10, // 44: services.RegressionService.End:output_type -> services.endResponse
	12, // 45: services.RegressionService.Start:output_type -> services.startResponse
	4,  // 46: services.RegressionService.GetTC:output_type -> services.TestCase
	15, // 47: services.RegressionService.GetTCS:output_type -> services.getTCSResponse
	16, // 48: services.RegressionService.PostTC:output_type -> services.postTCResponse
	17, // 49: services.RegressionService.DeNoise:output_type -> services.deNoiseResponse
	18, // 50: services.RegressionService.Test:output_type -> services.testResponse
	21, // 51: services.RegressionService.PutMock:output_type -> services.PutMockResp
	23, // 52: services.RegressionService.GetMocks:output_type -> services.getMockResp
	25, // 53: services.RegressionService.StartMocking:output_type -> services.StartMockResp
